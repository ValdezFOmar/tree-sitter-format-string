...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replacement, 4, 0, 5),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replacement, 4, 0, 5),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replacement, 4, 0, 4),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replacement, 4, 0, 4),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_expression, 4, 0, 9),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replacement, 5, 0, 8),
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replacement, 5, 0, 8),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replacement, 3, 0, 1),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replacement, 3, 0, 1),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replacement, 2, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replacement, 2, 0, 0),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replacement, 4, 0, 7),
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replacement, 4, 0, 7),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replacement, 3, 0, 2),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replacement, 3, 0, 2),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute_expression, 3, 0, 6),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replacement, 3, 0, 3),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replacement, 3, 0, 3),
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_format_specification, 2, 0, 0),
